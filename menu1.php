    ...
    <nav id="mainNav" class="navbar navbar-default navbar-fixed-top navbar-custom">
        <div class="container">
            ...
            <div class="navbar-header page-scroll">
               ...
               <a href="index.html"><img class="img-responsive" src="img/logo3.svg" alt=""></a>
            </div>
				    ...
				    <div class="col-lg-10 col-lg-offset-2 text-center">
    				    <div class="col-md-2 text-center">
							...
							<?php
								$c1p1=2;
								if ($p1==1){
									echo'<a href="menu.html" class="btn btn-lg btn-outline">
									1 <i class="fa fa-question-circle"></i>
									</a>';
								}else{									
									echo '<a href="menu.html" class="btn btn-lg btn-outline">
										1 <i class="fa fa-lock"></i></a>';
								}								
							?>
